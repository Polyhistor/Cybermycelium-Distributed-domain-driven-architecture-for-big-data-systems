...
Cybermycelium is made up of 11 main components and 7 variable components as depicted in figure \ref{Cybermycelium}.
...
For the purposes of effective modeling and abstraction, we've sub-diagrammed the product domain, which is portrayed in figure \ref{Cybermycelium Product Domain Design}

\begin{figure}[h!]
    \centering
    \includegraphics[width=12cm]{Media/Product Domain.jpg}
    \label{Cybermycelium Product Domain Design}
