...
\subsection{Step 1, 2, 3}

During the initial meeting, in step 1, ATAM was presented with clear description of its purposes.
...
After having understood the business cases and selecting a few good cases for BD processing, we created an archetype of Cybermycelium. 

For this purposes, ISO/IEC 25000 SQuaRE standard
(Software Product Quality Requirements and Evaluation) \cite{ISO25000} was used as a reference for quality technology selection.
