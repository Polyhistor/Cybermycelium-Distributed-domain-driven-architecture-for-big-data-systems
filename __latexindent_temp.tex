...
Data engineering is a complicated endevaour, and while there are many good practices of distribution in software engineering, the big data domain does not seem to benefit from all these ideas. This has made big data system development a daunting task, and many companeis have failed to bring to light the potential of a data-driven decision making. Therefore, there is more and more research required in the areas of data architecture, and the ways in which the data flows between various components. We think 
