...
Among the challenges of data adoption perhaps the most highlighted are 'data engineering complexities', 'data architecture', 'rapid technology change', 'lack of sufficiently skilled data engineers', and 'organization's cultural challenges of becoming data-driven' \cite{AtaeiBigDataEnvirons};\cite{Singh}. To this end, our study aims to address the challenges of data architecture by proposing a reference architecture (RA). RAs are suitable artifacts for development of complex systems as they capture the essence of knowledge for a class of systems and inject it into practices as high-level models that different stakeholders can reflect on.  
