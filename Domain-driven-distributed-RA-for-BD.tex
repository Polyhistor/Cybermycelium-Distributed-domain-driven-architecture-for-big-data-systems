...
\begin{enumerate}
    ...
    \item RAs can endow the overall data architecture with openness and increase operability, incorporating architectural patterns that ensue desirable predefined quality attributes
    ...
    \item RAs can scale the knowledge of engineers and architects
