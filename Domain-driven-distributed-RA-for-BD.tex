...
In this section, we articulate the current status of BD RAs, the value of reference architectures, and justify our contribute to the body of knowledge. 
...
Our research methodology is made up of two major elements. First, we explore the body of knowledge BD RAs to understand the requirements of this class of systems, and secondly we discuss our chosen method for developing the artifact. 
...
\begin{enumerate}
    \item Expanding on theories explained in \ref{State of the art}, and elucidating on the rationale for creating Cybermycelium
